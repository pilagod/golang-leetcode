...
func (s *Suite) TestNoInterval() {
	got := findRightInterval(nil)
	s.Equal([]int(nil), got)
}

func (s *Suite) TestOnlyOneInterval() {
	got := findRightInterval([][]int{{1, 2}})
	s.Equal([]int{-1}, got)
}

func (s *Suite) TestMultipleIntervals() {
